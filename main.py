...
while True and guesses < 3: 
    print("Pearl white chest without key or lid. Inside of which, a golden treasure is hid. What am I?  \n",'green', 'on_cyan')
    ...
    if "egg" in answer:
       ...
       guesses -=1
       cowsay.cow("The creator of this chest is a farm animal\n",'green', 'on_cyan')
